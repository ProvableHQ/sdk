...
export const AddressFromViewKey = () => {
    ...
    if (aleo !== null) {
        const address = () => addressFromViewKey !== null ? addressFromViewKey.to_address().to_string() : "";

        return <Card title="Load Address from View Key" style={{width: "100%", borderRadius: "20px"}}
                     bordered={false}>
            <Form {...layout}>
                <Form.Item label="View Key" colon={false}>
                    <Input name="viewKey" size="large" placeholder="View Key" allowClear onChange={onChange}
