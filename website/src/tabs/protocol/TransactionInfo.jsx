...
export const TransactionInfo = () => {
    ...
    const tryParseTransaction = (txData, needsStringify = true) => {
        const displayData = needsStringify
            ...
            const outputs = transitions.map((transition, index) => {
                ...
                return {
                    ...
                    outputs: transitionOutputs.map((output) => ({
                        ...
                        arguments:
                            output.arguments?.map((arg) => arg.toString()) ||
                            [],
                    })),
                };
            });
        ...
        <div className="container">
            ...
            <ul>
                ...
                <li>
                    ...
                    contains the execution proof, individual chain state
                    transitions (+ their inputs and outputs) and fee
                    information.
                </li>
                <li>
                    When the transaction communicates a program deployment it
                    contains the program, verifying keys & certificates for each
                    function and the fee information.
                </li>
            </ul>

            <br />
            <p>
                The Provable SDK provides methods for accessing the information
                within transactions and transitions allowing app developers to
                develop front or backend logic based on actions taken on the
                network.
            </p>

            <br />
            <Card title="Transaction" style={{ width: "100%" }}>
                <Form {...layout}>
                    <Form.Item
                        label={
                    ...
                    >
                        ...
                        >
                            <Radio.Button value="deploy">
                                Deploy Transaction
                            </Radio.Button>
                            <Radio.Button value="execute">
                                Execute Transaction
                            </Radio.Button>
                        </Radio.Group>
                    </Form.Item>
                        ...
                        {transactionType && (
                            ...
                            >
                                <Input
                                    ...
                                    disabled
                                    addonAfter={
                                        <CopyButton data={transactionType} />
                                    }
                                />
                            </Form.Item>
                        )}
