...
mod tests {
    ...
    fn test_file_loading_and_imports() {
        ...
        let test_path = setup_directory("aleo_test_file_resolution", ALEO_PROGRAM, imports).unwrap();
    ...
    fn test_hybrid_program_and_import_loading() {
        ...
        let test_path = setup_directory("aleo_test_hybrid_resolution", ALEO_PROGRAM, imports).unwrap();
