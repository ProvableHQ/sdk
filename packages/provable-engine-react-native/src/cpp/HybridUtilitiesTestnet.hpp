...
class HybridUtilitiesTestnet : public HybridUtilitiesSpec {
 public:
  explicit HybridUtilitiesTestnet() : HybridObject([]() -> const char* { static std::string k = std::string(TAG) + "Testnet"; return k.c_str(); }()) {}
