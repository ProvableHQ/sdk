import * as wasm from "@provablehq/provable-engine-wasm/mainnet.js";
import { createNativeBindings } from "./native-bindings.js";

export * from "@provablehq/provable-engine-wasm/mainnet.js";

const native = createNativeBindings(wasm as Record<string, any>, "mainnet");
