...
Parameters | Type | Description
--- | --- | ---
__The__ | `ViewKey` | *view key of the account that encrypted the ciphertext.*
...
### `decrypt_with_transition_info(view_key, transition_public_key, program, function_name, index) ► Plaintext`
...
### `decrypt_with_transition_view_key(transition_view_key, program, function_name, index) ► Plaintext`
