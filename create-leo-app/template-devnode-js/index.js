...
async function main() {
    ...
    const tx_1 = await programManager.buildDevnodeDeploymentTransaction({
        program: program,
        priorityFee: 0,
        privateFee: false,
    });
    ...
    const tx_2 = await programManager.buildDevnodeUpgradeTransaction({
        program: upgraded_program,
        priorityFee: 0,
        privateFee: false,
    });
