...
async function deployProgram(program) {
  ...
  const account = new Account({
    // privateKey: "APrivateKey1zkpDH1p2331zeoQCWg7UW2E8skKWimLSxMQAM6ARBpuzMmy"  // account
    privateKey: "APrivateKey1zkp8CZNn3yeCseEtxuVPbDCwSyhGW6yZKUYKfgXmcpoGPWH",  // node 0
  });
  ...
  const fee = 1010.0; // 1.9 Aleo credits
