...
describe("Program Manager", () => {
    ...
    programManager.setAccount(
        new Account({ privateKey: statePathRecordOwnerPrivateKey }),
    );
    ...
    describe("Offline query", () => {
        it.skip("The offline query should work as expected", async () => {
            ...
            const record_plaintext =
                RecordPlaintext.fromString(statePathRecord);
            const commitment = record_plaintext
                .commitment("credits.aleo", "credits")
                .toString();
            ...
            const execution_result = <ExecutionResponse>(
                await programManager.run(
                    credits,
                    "transfer_private",
                    [statePathRecord, beaconAddressString, "5u64"],
                    true,
                    undefined,
                    undefined,
                    undefined,
