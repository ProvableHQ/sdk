...
class AleoNetworkClient {
    ...
    fetchData(url = "/") {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios.get(this.host + url);
    ...
    findUnspentRecords(startHeight, endHeight, privateKey, amounts, maxMicrocredits, nonces) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const blockHeight = yield this.getLatestHeight();
            ...
            while (end > startHeight) {
                ...
                try {
                    ...
                    const blocks = yield this.getBlockRange(start, end);
                    end = start;
                                                        ...
                                                        if (output.type === "record") {
                                                            try {
                                                                ...
                                                                if (record.isOwner(viewKey)) {
                                                                    ...
                                                                    try {
                                                                        yield this.getTransitionId(serialNumber);
                                                                    }
                                                                    catch (error) {
    ...
    getBlock(height) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const block = yield this.fetchData("/block/" + height);
                return block;
            }
            catch (error) {
    ...
    getBlockRange(start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/blocks?start=" + start + "&end=" + end);
            }
            catch (error) {
    ...
    getLatestBlock() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/latest/block");
            }
            catch (error) {
    ...
    getLatestHash() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/latest/hash");
            }
            catch (error) {
    ...
    getLatestHeight() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/latest/height");
            }
            catch (error) {
    ...
    getProgram(programId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/program/" + programId);
            }
            catch (error) {
    ...
    getProgramObject(inputProgram) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    return Program.fromString((yield this.getProgram(inputProgram)));
                }
                catch (error) {
    ...
    getProgramImports(inputProgram) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const program = inputProgram instanceof Program ? inputProgram : (yield this.getProgramObject(inputProgram));
                ...
                for (let i = 0; i < importList.length; i++) {
                    ...
                    if (!imports.hasOwnProperty(import_id)) {
                        const programSource = yield this.getProgram(import_id);
                        const nestedImports = yield this.getProgramImports(import_id);
    ...
    getProgramMappingNames(programId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/program/" + programId + "/mappings");
            }
            catch (error) {
    ...
    getProgramMappingValue(programId, mappingName, key) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/program/" + programId + "/mapping/" + mappingName + "/" + key);
            }
            catch (error) {
    ...
    getStateRoot() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/latest/stateRoot");
            }
            catch (error) {
    ...
    getTransaction(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/transaction/" + id);
            }
            catch (error) {
    ...
    getTransactions(height) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/block/" + height.toString() + "/transactions");
            }
            catch (error) {
    ...
    getTransactionsInMempool() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/memoryPool/transactions");
            }
            catch (error) {
     ...
     */
    getTransitionId(transition_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.fetchData("/find/transitionID/" + transition_id);
            }
            catch (error) {
